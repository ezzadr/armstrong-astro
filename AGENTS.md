...
- **ABSOLUTE HIGHEST PRIORITY PROTECTION — ARMSTRONG AI DISPATCH (`armstrong-ai-call-dispatch` / `jqkvdrpcfz`):** This is the user's most critical project. Under NO circumstances should any operation, automated task, cleanup script, or server manipulation risk its stability, execution, webhooks, or database data. Any action with even the slightest risk to this application is strictly PROHIBITED.
